...
l.70~l.78 配列の最初のデータから1つずつ入力したIDと照らし合わせて、一致すればその時のindexを返す。一致しなければ-1を返す。
l.88~l.99 全てのデータの真ん中の値と入力したIDを照らし合わせて、一致すればその時のindexを返す。入力したIDが照らし合わせたIDより大きければ最初に比較したIDより大きいデータの真ん中のIDを照らし合わせ、小さければ最初に比較したIDより小さいデータの真ん中のIDと照らし合わせる。
