...
l.112~114 到着してない駅のvisitedに0を代入
l.116 スタックを初期化
l.117　出発地点をPush
l.119~135　スタックが空ではないときPopする
l.122~134　1度も到着していない駅ならvisitedに1を代入し、駅名を出力。その場所から行ける場所をPushする
l.206~208 到着してない駅のvisitedに0を代入
l.210 キューを初期化
l.211　出発地点をEnqueueする
l.213~228　キューが空ではないときDequeueする
l.216~226　1度も到着していない駅ならvisitedに1を代入し、駅名を出力。その場所から行ける場所をEnqueueする
